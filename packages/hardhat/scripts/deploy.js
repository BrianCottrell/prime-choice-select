...
const main = async () => {
  ...
  const paymentContract = await deploy("PaymentContract"); // <-- add in constructor args like line 19 vvvv

  //const paymentContract = await ethers.getContractAt('PaymentContract', "0xaAC799eC2d00C013f1F11c37E654e59B0429DF6A") //<-- if you want to instantiate a version of a contract at a specific address!
